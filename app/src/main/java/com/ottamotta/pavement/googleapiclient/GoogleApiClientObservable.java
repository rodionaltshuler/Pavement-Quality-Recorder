package com.ottamotta.pavement.googleapiclient;
...
import com.ottamotta.pavement.googleapiclient.exceptions.GoogleApiClientConnectionException;
        ...
        super(singleSubscriber -> {
            ...
            googleApiClient.registerConnectionCallbacks(new GoogleApiClient.ConnectionCallbacks() {
                ...
                public void onConnectionSuspended(int i) {
                    singleSubscriber.onError(new GoogleApiClientConnectionException(null));
                }
            });
